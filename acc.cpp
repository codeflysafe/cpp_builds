//
// Created by sjhuang on 2022/7/26.
//
...
int main()
{
    ...
    ///输入图片的路径，你也可以改成外部传参argv的方式，或者是读取视频文件
    string imgpath = "/Users/sjhuang/Documents/projects/deep_learning_projects/paper_implementations/YOLO_master/assets/dog.jpg";
